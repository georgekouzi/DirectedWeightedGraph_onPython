...
class GraphAlgoTestCase(unittest.TestCase):
    ...
    def test_one_node_graph(self):
        ...
        self.assertEqual(graph_algo.shortest_path(1, 0), (None, None))
        self.assertEqual(graph_algo.shortest_path(0, 1), (None, None))
    ...
    def test_two_node_graph(self):
        ...
        self.assertEqual(graph.e_size(), 0)
        self.assertEqual(graph_algo.shortest_path(1, 2), (math.inf, None))
